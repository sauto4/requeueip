...
func (fn GetIpamHealthzHandlerFunc) Handle(params GetIpamHealthzParams) middleware.Responder {
	return fn(params)
}
...
func NewGetIpamHealthz(ctx *middleware.Context, handler GetIpamHealthzHandler) *GetIpamHealthz {
	return &GetIpamHealthz{Context: ctx, Handler: handler}
}
...
func (o *GetIpamHealthz) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	var Params = NewGetIpamHealthzParams()
