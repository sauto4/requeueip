...
// WithArgs adds the args to the delete ipam ips params
func (o *DeleteIpamIpsParams) WithArgs(args *models.CmdDelArgs) *DeleteIpamIpsParams {
	o.SetArgs(args)
	return o
}

// SetArgs adds the args to the delete ipam ips params
func (o *DeleteIpamIpsParams) SetArgs(args *models.CmdDelArgs) {
	o.Args = args
}
