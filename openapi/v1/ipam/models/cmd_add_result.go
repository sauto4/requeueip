...
func (m *CmdAddResult) validateDNS(formats strfmt.Registry) error {
...
func (m *CmdAddResult) validateIps(formats strfmt.Registry) error {
...
func (m *CmdAddResult) validateRoutes(formats strfmt.Registry) error {
...
func (m *CmdAddResult) contextValidateDNS(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CmdAddResult) contextValidateIps(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CmdAddResult) contextValidateRoutes(ctx context.Context, formats strfmt.Registry) error {
